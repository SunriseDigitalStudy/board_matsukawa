...
abstract class Bd_Orm_Main_Base_Table_ThreadTag extends Bd_Db_Table
{
    ...
    private static $_name = 'thread_tag';

    private static $_swap_name = null;

    private static $_record_class_name = 'Bd_Orm_Main_ThreadTag';

    protected static $_class_suffix = 'ThreadTag';
