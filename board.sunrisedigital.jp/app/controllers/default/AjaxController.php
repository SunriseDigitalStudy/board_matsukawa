...
//      $thread1[] = $thread->getId();
//      $thread1[] = $thread->getTitle();
//      if($thread->get('updated')){
//        $thread1[] = $thread->getZendDate('updated')->get('yyyy年MM月dd日(E) HH時mm分ss秒');
//        $thread_list1[] = $thread1;
//      } 
//      $thread1 = array();
//    }
    
    
    echo json_encode($thread_list1);
    Sdx_Debug::dump($thread_list->getFirstRecord()->getId(),'record');
//    Sdx_Debug::dump($thread_list->getFirstRecord()->getZendDate('updated')->get('yyyy年MM月dd日(E) HH時mm分ss秒','record'), 'yyyyy');
    
    Sdx_Debug::dump($thread_list1 , '$thread_list1 ');
    Sdx_Debug::dump($thread1 , 'thread1 ');
